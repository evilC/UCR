...
class _InputButton extends _BannerMenu {
	...
	; Other internal vars
	_IsOutput := 0
	_BindTypes := {AHK_KBM_Input: "AHK_KBM_Input", AHK_Joy_Buttons: "AHK_Joy_Buttons", AHK_Joy_Hats: "AHK_Joy_Hats"}
	_IOClassNames := ["AHK_KBM_Input", "AHK_Joy_Buttons", "AHK_Joy_Hats"]
	_BindObjects := {}
