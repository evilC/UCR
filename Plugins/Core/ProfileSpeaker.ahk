...
class ProfileSpeaker extends _Plugin {
	...
	Init(){
		...
		this.AddControl("SpeechText", 0, "Edit", "x100 yp-3 w500", this.ParentProfile.Name)
	}
	
	; Called when plugin (ie profile) becomes active
	OnActive(){
		UCR.Libraries.TTS.Speak(this.GuiControls.SpeechText.value)
	}
