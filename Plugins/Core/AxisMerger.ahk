...
class AxisMerger extends _UCR.Classes.Plugin {
	...
	Init(){
		...
		this.AddControl("AxisPreview", "", 0, this.IOControls.InputAxis1, "xm w125")
		this.AddControl("AxisPreview", "", 0, this.IOControls.InputAxis2, "x+5 yp w125")
		...
		this.AddControl("AxisPreview", "", 0, this.IOControls.OutputAxis, " x+5 yp w100")
	}
